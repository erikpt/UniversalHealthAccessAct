...
(c) **Medical Advisory Committee (MAC).**
   1. **Composition and Selection**: Two doctors per state (100 total), selected by random lottery from all licensed physicians in each state. Terms: 2 years, non-renewable, commencing in odd-numbered years (opposite congressional elections) to minimize political influence. HHS shall oversee the lottery process, ensuring fair representation across specialties, geographies, and demographics.
   2. **Duties**: Conduct biennial reviews of the essential services list (including co-pay applicability, reimbursement rates, and phased expansions like mental health/vision), recommending additions, removals, or modifications based on evidence-based medicine, cost-effectiveness, technological advancements, and public health needs. Initial list mirrors Medicare-covered services as of 2026.
   3. **Review Process**: The MAC shall convene biennially for a structured 5-day session divided into two phases: (i) a 3-day proposal session where members submit and debate changes, open to virtual participation; followed by (ii) a 90-day public comment period for stakeholder input (including providers, patients, and experts), with comments published on the National Health Portal; and (iii) a final 2-day ratification session where proposals are voted on. Decisions require a two-thirds majority and are binding unless overridden by Congress via joint resolution within 60 days. All proceedings shall be recorded, transcribed, and publicly accessible.
   4. **Compensation and Support**: Committee members shall receive a stipend of $2,500 per biennial term to cover travel, lodging, and related expenses, indexed annually to the Consumer Price Index (CPI) starting from the base year of enactment. Upon each new lottery selection, HHS shall review and adjust the stipend as needed based on inflation and actual costs, with adjustments not exceeding 10% per term and funded from the administrative cap.
   5. **Depoliticization**: Lottery ensures randomized representation of specialties; no political appointments. Members must disclose conflicts of interest; violations result in immediate removal and replacement via supplemental lottery.
